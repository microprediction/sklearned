from sklearned.incremental.humpdayincreasingchallenge import humpday_increasing_challenge
...
if __name__=='__main__':
    ...
    n_trials = 5000
    best_test, best_model, best_search_params = humpday_increasing_challenge(global_optimizer=optimizer, embedding_name=embedding_name, skater_name=skater_name, k=k, n_input=n_input, n_trials =n_trials)
    print(best_test)
